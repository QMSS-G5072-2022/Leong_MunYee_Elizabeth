...
from springerprojectdraft.springerprojectdraft import check_parameters
from springerprojectdraft.springerprojectdraft import ResultsAnalysis
import pandas as pd
df_list = [['Article',
...
def test_RA_add(test_df):
    with pytest.raises(ValueError) as errorinfo:
        test_df.add({'hello':10})
